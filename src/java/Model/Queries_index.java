...
public class Queries_index {
    ...
    public static alertasDashboard alertasDashboard() throws FileNotFoundException{
        Conexion Conexion = new Conexion();
        ResultSet r2 = Conexion.query("select a.id_alerta, concat(LEFT(cat.nombre, 20),'...') as nombre, l.clave as clave  from  alerta a left join cat_alerta cat on a.fk_id_cat_alerta = cat.id_cat_alerta \n" +
