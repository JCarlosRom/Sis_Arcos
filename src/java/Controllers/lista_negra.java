...
public class lista_negra {   
    ...
    public lista_negra() throws IOException {
        jdbcTemplate = new JdbcTemplate(conect.conectar());
    }
    @GetMapping("listaNegra.htm")
   
    // Metodo para redireccionar a listaNegra.htm
    public String lista_negra(Model m) {
        m.addAttribute("cat_udai", getCatUdai());
        return "listaNegra";
    }
    
    @RequestMapping("listaNegra_detalle.htm")
    public String listaNegra_detalle(Model m) {      
        m.addAttribute("cat_udai", getCatUdai());
        return "listaNegra_detalle";
    }
    
    @RequestMapping(value = "insertarLista.htm", method = RequestMethod.POST)    
    public void insertar(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, ParseException, java.text.ParseException {        
        ...
        public CallableStatement createCallableStatement(Connection con) throws SQLException {
            ...
            callableStatement.setBoolean(12,Boolean.parseBoolean(request.getParameter("cad")));
            callableStatement.setBoolean(13,Boolean.parseBoolean(request.getParameter("udai")));
            callableStatement.setInt(14,Integer.parseInt(request.getParameter("selectNegra")));
    ...
    @RequestMapping(value = "actualizar_edo.htm", method = RequestMethod.POST)    
    ...
    @RequestMapping(value = "/getListaNegra.htm", method = RequestMethod.GET)
    public void getListaNegra(HttpServletResponse response) throws java.text.ParseException, IOException {
        String SQL = "SELECT * FROM sp_lista_negra_get();";
    ...
    public static Timestamp convertDateFromAppToDb(String date) throws java.text.ParseException {
     ...
     @RequestMapping(value = "/getRegitroById.htm", method = RequestMethod.GET)
     ...
     @RequestMapping(value = "/searchRange.htm", method = RequestMethod.GET)
