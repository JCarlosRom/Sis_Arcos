                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="modFechaInicial" name="modFechaInicial" class="form-control" type="datetime-local">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="recipi" class="col-form-label">Fecha final</label>
                                                    <input id="modFechaFinal" name="modFechaFinal" class="form-control" type="datetime-local">                                       
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-check">
        ...
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAdTfw1waJScSYaMdXKGqAW6rnHcwmjZwc&callback=initMap"></script>
         ...
         <script>
                           $(document).ready(function () {
                               ...
                               var maximizar = $(' <a class="fas fa-external-link-square-alt" href="listaBlanca_detalle.htm" target="_blank"><i class=""></i></a>');
                               ...
                               $('body').on('click', '#exportW', function (e) {
                                   $.fn.DataTable.Export.word(tabla, {
                                       ...
                                       filename: 'Reporte_lista_blanca',
                                       title: 'Reporte lista blanca',
                                       fields: [
                                           "fecha_i_fecha_f",
                                           "placa_niv",
                                           "Motivo",
