...
<html lang="en">
    ...
    <head>
        ...
        <title>Lista negra detalle</title>
    ...
    <body class="theme-dark" style="color:white;">
        ...
        <main >
            <div style="background-color: #05151C;">
                <h6 class="p-4" style="color:white;">Consulta lista negra</h6>
                    ...
                    <div class="card-header">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-3">                                
                                    <input id="fecha_inicial" class="form-control" type="datetime-local" required="required">
                                </div>
                                <div class="col-md-3">
                                    <input id="fecha_final" class="form-control" type="datetime-local" required="required">
                                </div>
                          ...
                          $(document).ready(function () {
                              ...
                              $('body').on('click', '#exportW', function (e) {
                                  ...
                                  $.fn.DataTable.Export.word(tabla, {
                                      filename: 'Reporte_lista_negra_detalle',
                                      title: 'Reporte lista negra detalle',
                                      fields: [
                                          "fecha_i_fecha_f",
                                          "placa_niv",
                                          "Motivo",
