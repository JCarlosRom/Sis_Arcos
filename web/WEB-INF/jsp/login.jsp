...
<%
    ...
    System.out.println("sesiolnnnnnnn: "+session.getAttribute("usuario"));
%>
...
<html>
                ...
                <div class="row">
                    <div class="col-md-6" style="background-color:#EAEAEA ; border: 2px solid #FFFFFF;border-radius: 20px 0px 0px 20px; padding-right: -5px;">
                        ...
                        <div class="">
                            ...
                            <form class="input-usuario" action="login_1.htm" method="POST">
                                <input type="text" class="form-control input-usuario-icon" name="inputUsuario" placeholder="nombre de usuario" required autocomplete="off">
                                <br>
                                <input type="password" class="form-control input-pass-icon" name="inputPassword" placeholder="contraseña" required autocomplete="off">
                                <br>
    ...
    crossorigin="anonymous"></script>
        ...
        <script src="<c:url value="/javascript/vendors/bootstrap.js" />"></script>
